...
typedef enum {
	SEARCHING, SUCCES, WRONG_PARAMETER_NAME, COMMAND_DOES_NOT_EXIST, FIND_MAIN, PROBLEM_IN_PLACEMENT,
	PROBLEM_OPERAND, NOT_PART_OF_NAME_OPTION, IDENTATION_ERROR, SYNTAX_ERROR, NOT_PART_OF_NUMBER, CODE_AFTER_MAIN,
	VARIABLES_GRAPH,CHECK_VARIABLES_GRAPH, NUMBERS_GRAPH, CONDITION_GRAPH
} Status;
